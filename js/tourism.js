...
// 結果描画完了カウント
// ===============================
function handleTourismResultRendered() {
    completedTourismResults++;

    if (completedTourismResults === 1) {
        hideLoadingState();
